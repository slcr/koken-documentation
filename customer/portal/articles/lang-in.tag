...
<head>
  ...
  <meta pod-id="" />
	  <link href="http://assets3.desk.com/assets/portal_jqueryui_only-ceeb07c81cef8c81cd0cdecfb39482b1.css" media="screen" rel="stylesheet" type="text/css" />
		<script src="http://assets3.desk.com/assets/vendor-c0a3f0c532dd6db2d09875a0ea69a8b0.js" type="text/javascript"></script>
		<script src="http://assets1.desk.com/assets/customer_widget-044efc6df9c5a6cdfe09ae38cde0fa38.js" type="text/javascript"></script>
		<script src="http://assets1.desk.com/assets/portal-28aef2dc34fbec2446f84227d717ae92.js" type="text/javascript"></script>
	...
	<script src="http://assets3.desk.com/assets/tracking-fa783f3c0c6abfbb760eb8ead6cb554e.js" type="text/javascript"></script>

    <script src="http://deskwww.s3.amazonaws.com/new/javascripts/deskanalytics.js" type="text/javascript"></script>


<script src="http://assets1.desk.com/assets/tracking/settings/production-158454f93db4467614c0b03dd247b5b0.js" type="text/javascript"></script>

	<meta content="authenticity_token" name="csrf-param" />
<meta content="bi/9vmFVIEQZc5+eF6oqItOiU60WjTmW3/HXL6hv7Wc=" name="csrf-token" />

		


<link rel='SHORTCUT ICON' type='image/ico' href='https://koken.desk.com/customer/portal/theme_attachments/21965?cb=1409243493500' />
<link rel='icon' type='image/png' href='https://koken.desk.com/customer/portal/theme_attachments/21965?cb=1409243493500' />


<link href="http://assets.koken.me/help/prettify/prettify.css" type="text/css" rel="stylesheet" />
<link href="http://assets.koken.me/help/prettify/koken.css" type="text/css" rel="stylesheet" />

<script type="text/javascript" src="http://assets.koken.me/help/prettify/prettify.js"></script>
...
<style type="text/css">
  ...
  #company-header h1 {
    background: url('http://assets3.desk.com/images/portal/portal-icon.png') 0 center no-repeat;
    color: #FFF;
    font-size: 25px;
    padding: 0 0 0 35px;
    float: left;
  ...
  #support-main .dashboard .topic li {
    background: url('http://assets3.desk.com/images/portal/featured-bullet.png') -2px 5px no-repeat;
    margin: 0 0 5px;
    padding: 0 0 0 15px;
  }
  ...
  #support-main .dashboard h5 {
    background: url('http://assets3.desk.com/images/portal/icon-types-small.png') 0 0 no-repeat;
    height: 16px;
    font-size: 13px;
  ...
  #support-main .articles li.question {
    background: url('http://assets3.desk.com/images/portal/icon-types.png') 0 3px no-repeat;
    padding: 0 0 0 40px;
  }

  #support-main .articles li.article {
    background: url('http://assets3.desk.com/images/portal/icon-types.png') 0 -276px no-repeat;
    padding: 0 0 0 40px;
  }
  ...
  #support-main .articles .meta .answered {
    background: url('http://assets3.desk.com/images/portal/check.png') 0 center no-repeat;
  ...
  #attachments strong {
    background: url('http://assets3.desk.com/images/attachment.png') -1px 0 no-repeat;
    display: block;
    margin: 0 0 10px;
    padding: 0 0 0 16px;
  }
  ...
  #rate_article_container a {
    background: url('http://assets3.desk.com/images/portal/rating-arrows.gif') center 4px no-repeat;
    overflow: hidden;
    float: left;
    width: 20px;
    height: 16px;
  ...
  #support-main .question .answer-rating a {
    background: url('http://assets3.desk.com/images/portal/rating-arrows.gif') center top no-repeat;
    display: block;
    height: 14px;
    text-align: center;
    text-indent: -900px;
  ...
  #form .input-button input {
    background: url('http://assets3.desk.com/images/portal/button.gif') 0 0 repeat-x;
    border: 0;
    color: #FFF;
    font-size: 12px;
    font-weight: bold;
  ...
  .ui-autocomplete .QnaThread {
    background: url('http://assets3.desk.com/images/portal/icon-types-small.png') 0 4px no-repeat;
    display: block;
    padding: 0 0 0 25px;
    overflow: hidden;
  }
  ...
  .gs-idea {
    background: url('http://assets3.desk.com/images/portal/getsatisfaction/idea_mini.png') 0 0 no-repeat !important;
    background-position: 0px 1px;
  }

  .gs-question {
    background: url('http://assets3.desk.com/images/portal/getsatisfaction/question_mini.png') 0 0 no-repeat !important;
    background-position: 0px 1px;
  }

  .gs-praise {
    background: url('http://assets3.desk.com/images/portal/getsatisfaction/praise_mini.png') 0 0 no-repeat !important;
    background-position: 0px 1px;
  }

  .gs-update {
    background: url('http://assets3.desk.com/images/portal/getsatisfaction/update_mini.png') 0 0 no-repeat !important;
    background-position: 0px 1px;
  }

  .gs-problem {
    background: url('http://assets3.desk.com/images/portal/getsatisfaction/problem_mini.png') 0 0 no-repeat !important;
    background-position: 0px 1px;
  }
...
#social-share .share-btn .fb-like {
  ...
  .myportal .mycases tbody th, tbody td {
    text-align:left;
  ...
  #support-main .myportal .case-details img {
    margin-right: 5px;
    float:left;
  }
...
/* Private Portal - My Account */
  ...
  .myaccount-form div[id^="email_"] form div {
    position: absolute;
    top: 14px;
    right: 10px;
  }
  ...
  .myaccount-form div[id^="email_"] .verified {
    display: block;
    float: right;
    padding-right: 10px;
    color: #5FA400;
  ...
  .myaccount-form div[id^="email_"] form input[type="submit"] {
    height: 25px;
  }
...
<link href="http://assets.koken.me/help/css/pe-icon-7-stroke.css" type="text/css" rel="stylesheet">
<link href="http://assets.koken.me/help/css/desk201408.css" rel="stylesheet" type="text/css" />
...
<div id='company-support-portal'>
  <div id='company-header'>
    <div class='wrapper'>
      <h1><a href='/'></a></h1>
<div class="extra">
  <h2><a href='/' title="Koken Help Center">Help Center</a></h2>
<ul>
  <li>
    <a href="/" title="Koken Help Center">Topics</a>
  </li>
  <li>
    <a href="http://help.koken.me/customer/portal/questions/new" title="Ask a question">Ask a question</a>
  </li>
  <li>
    <a href="http://help.koken.me/customer/portal/emails/new?t=484231" title="Contact Koken support directly">Email us</a>
  </li>
  <li>
            <a href="https://twitter.com/intent/tweet?screen_name=koken" title="Koken on Twitter" onclick="window.open(this.href); return false;">Tweet us</a>
          </li>

    <li>
    <a href="http://blog.koken.me" title="Koken Blog" onclick="return !window.open(this.href);">Blog</a>
  </li>
    <li>
    <a href="http://store.koken.me/" title="Koken Store - Free and premium themes and plugins" onclick="return !window.open(this.href);">Store</a>
  </li>
</ul>
</div>
      ...
      <form action='/customer/portal/articles/search' method='get' id='support-search' class='support-search-small'>
          <div>
            ...
            <span class="search_glass pe-7s-search"></span>
          </div>
        </form>
    ...
    <div id='support-side'>
      ...
      <div class='content'>
        ...
        <section>
          <h2>About Koken</h2>
          <p>
          This Help Center provides support for <a href="http://koken.me" title="Koken">Koken</a>, a free content management system designed for photographers, artists and designers.
          </p>
        </section>

      <section>
          <a href="https://twitter.com/koken" class="twitter-follow-button" data-show-count="false">Follow @koken</a>
          <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
      </section>

      <section>
      <div class="fb-like" data-href="http://facebook.com/kokencms" data-send="false" data-layout="button_count" data-width="190" data-show-faces="true" data-font="arial"></div>
      </section>
...
<!--begin:page_article--><div id="jump_head">
  <div class="wrapper">
    <div class="lcol">
      
    </div>
    <div class="rcol">
      <a href="#top" title="Back to top">Back to top</a><div id="jumpto_scroll"></div></div>
    </div>
   </div>
</div>
...
<div id='breadcrumbs'>
  <a href='/'>Home</a>
        ...
        <a class='bttn-small' href='/customer/portal/questions/new' title='Ask a question'>Ask a question</a>

</div>
    
    <div id='social-share'>
      <div class='share-btn'>
        <a href="https://twitter.com/share" class="twitter-share-button" data-lang="en" data-count="vertical"></a>
      </div>
      <div class='share-btn'>
    ...
    <div class='content article'>
      ...
      <h1>This article doesn&#39;t have a translation for  English</h1>
  ...
  ****************
  ...
  <div id='footer'>
    <ul class="footer_nav">
  <li>
    <a href="http://koken.me">Koken.me home</a> 
  </li>
  <li>
            <a href="https://twitter.com/intent/tweet?screen_name=koken" title="Koken on Twitter" onclick="window.open(this.href); return false;">Tweet us @Koken</a>
          </li>
<li>
            <a href="http://facebook.com/kokencms" title="Follow us on Facebook" onclick="window.open(this.href); return false;">Facebook</a>
          </li>
  <li>
    <a href="https://plus.google.com/+KokenMe" onclick="window.open(this.href); return false;">Google+</a>
  </li>
  <li>
    <a href="http://blog.koken.me">Blog</a>
  </li>
</ul>

&copy; 2013-4 Koken. All Rights Reserved.
    <br/>
...
$(window).scroll(function() {
    if ($(this).scrollTop()>319) {
        $('#jump_head:hidden').stop(true, true).fadeIn();
    } else {
        $('#jump_head').stop(true, true).fadeOut();
    }
});
</script><!--end:page_article-->
...
<div id="desk-external-variables-header" class="desk-external-variables">
   <div id="read_only"></div>
    <div id="site-default_mailbox">support@koken.me</div>
  <div id="desk_javascript_host">http://assets0.desk.com/</div>
  <div id="twitter_enabled">false</div>
  <div id="twitter_username">koken</div>
  ...
  <div id="site-search_autocomplete_articles_url">/customer/en/portal/articles/autocomplete</div>
  <div id="search-term"></div>
  
</div>

<script type="text/javascript" src="http://assets0.desk.com/portal/desk.portal.shared.js"></script>
<script type="text/javascript" src="http://assets0.desk.com/portal/desk.portal.header.js"></script>
<script type="text/javascript" src="http://assets0.desk.com/portal/desk.portal.body.layout_footer.js"></script>
...
<script>
  $(function() {
     ...
     if (pathname!="/") { 
        $('#support-side ul li a').each(function() {
...
<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-36460516-1']);
